...
public class UserTests2 {
	...
	public void testPostUser(ITestContext context) {
		...
		Response createRes = UserEndpoints2.createUser(userPayload);
	...
	public void testGetUser() {
		...
		Response getRes= UserEndpoints2.getUser(this.userPayload.getUsername());
		getRes.then().log().all();
	...
	public void testUpdateUser() {
		...
		Response updateRes = UserEndpoints2.updateUser(userPayload, this.userPayload.getUsername());
		updateRes.then().log().all();
		
		Assert.assertEquals(updateRes.getStatusCode(), 200);
		
		//checking data for update
		Response resAfterUpdate= UserEndpoints2.getUser(this.userPayload.getUsername());
	...
	public void testDeleteUser() {
		Response deleteRes = UserEndpoints2.deleteUser(this.userPayload.getUsername());
